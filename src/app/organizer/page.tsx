    ...
    <div className="flex flex-col h-full overflow-y-auto">
      ...
      <form onSubmit={handleSubmit} className="px-10 lg:px-12 pb-10 flex-1">
        ...
        <div className="flex gap-3 mb-6">
          <button type="button" className="flex-1 flex items-center justify-center gap-2 border border-stone-200 hover:cursor-pointer hover:border-stone-300 hover:bg-stone-50 rounded-xl py-2.5 text-sm font-semibold text-stone-600 transition-all">
        ...
        <p className="text-center text-stone-400 text-xs mt-5">
          ...
          <button
            ...
            className="text-amber-500 hover:cursor-pointer hover:text-amber-600 font-bold transition-colors"
          >
